...
abstract class CFA_Turtle extends Animal {
    ...
    private boolean cfa_getWalkTargetValue(boolean original, @Local(argsOnly = true, name = "pos")BlockPos pos) {
        return original || canSwimInFluidType(level().getFluidState(pos).getFluidType());
    }
}
