...
abstract class CFA_AgeableWaterCreature extends AgeableMob {
    
    protected CFA_AgeableWaterCreature(EntityType<? extends AgeableMob> type, Level level) {
        super(type, level);
    }
    
    @ModifyExpressionValue(method = "handleAirSupply(I)V",
    at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/animal/AgeableWaterCreature;isInWater()Z"))
     ...
     */
    @ModifyExpressionValue(method = "checkSurfaceAgeableWaterCreatureSpawnRules(Lnet/minecraft/world/entity/EntityType;Lnet/minecraft/world/level/LevelAccessor;Lnet/minecraft/world/entity/EntitySpawnReason;Lnet/minecraft/core/BlockPos;Lnet/minecraft/util/RandomSource;)Z",
